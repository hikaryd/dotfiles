{ inputs, ... }: {
  ...
  programs.hyprpanel = {
    ...
    override = {
      ...
      theme.bar.buttons.workspaces.numbered_active_highlight_border = "0.55em";
      theme.bar.buttons.spacing = "0.25em";
      theme.bar.buttons.workspaces.enableBorder = false;
      theme.bar.buttons.dashboard.enableBorder = false;
      theme.bar.buttons.workspaces.fontSize = "1.3em";
      theme.bar.menus.menu.media.scaling = 97;
      theme.bar.menus.menu.notifications.scaling = 100;
      theme.bar.menus.menu.clock.scaling = 100;
      theme.bar.menus.menu.battery.scaling = 95;
      theme.bar.menus.menu.network.scaling = 97;
      theme.bar.menus.menu.volume.scaling = 96;
      theme.bar.buttons.padding_x = ".98rem";
      ...
      theme.bar.menus.menu.notifications.height = "69em";
    ...
    settings = {
      layout = {
        bar.layouts = {
          "0" = {
            left = [ "dashboard" "windowtitle" "media" "systray" ];
            middle = [ ];
            right = [ "network" "bluetooth" "battery" "notifications" "clock" ];
          };
      ...
      bar.workspaces.scroll_speed = 2;
      bar.clock.icon = "󰥔";
      bar.notifications.show_total = true;
      bar.battery.scrollUp = "brightnessctl set 1%+";
      bar.battery.scrollDown = "brightnessctl set 1%-";
      ...
      bar.customModules.updates.updateCommand =
        "$HOME/.local/scripts/checkforupdates";
      ...
      bar.media.truncation_size = 23;
      menus.dashboard.powermenu.avatar.image = "/home/greed/.face";
      bar.network.showWifiInfo = true;
      bar.battery.hideLabelWhenFull = true;
      menus.clock.weather.unit = "metric";
      menus.clock.weather.key = "93d30f7a628cc7abad07b1d4b3efd9bc";
