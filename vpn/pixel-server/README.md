...
- noVNC показывает Android и передаёт разрешённый владельцем ввод. Это не
  терминал и не способ обойти PIN/защищённые окна Android.
- Hermes не получает пароль владельца/VNC, ключи Termux/ADB или административный shell.
...
- Перезапуск Android/capture и длительная автономность требуют отдельных проверок
  и могут требовать ручного PIN/разрешения захвата. Дополнительные полномочия
  Hermes и доступ к внутренним устройствам автоматически не предоставляются.
