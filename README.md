...
# откатить конфиги: симлинки, Firefox/Zen/AyuGram/Claude, твики шелла и defaults
./uninstall
...
Удаляются только симлинки, указывающие в этот репозиторий. Скопированные
файлы не удаляются, а переезжают в `~/dots-uninstall-backup-<дата>/`
(со списком действий в `MANIFEST.txt`) — ничего не теряется.
