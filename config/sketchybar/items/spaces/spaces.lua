...
if WINDOW_MANAGER == "rift" then
  window_manager = require("items.spaces.window_managers.rift")
elseif WINDOW_MANAGER == "aerospace" then
  -- Для обратной совместимости, если кто-то использовал aerospace
  window_manager = require("items.spaces.window_managers.rift")
else
