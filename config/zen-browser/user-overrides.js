...
// Based on: https://github.com/sobolevn/dotfiles/blob/master/firefox/user-overrides.js
...
// Zen UI — No Gaps theme
user_pref("theme.no_gaps.fixes.center_split_view", true);
user_pref("theme.no_gaps.gaps", false);
user_pref("theme.no_gaps.rounded_corners", true);
...
// Zen context menu cleanup
user_pref("uc.fixcontext.applyzencolors", true);
user_pref("uc.hidecontext.addtowebpanel", true);
...
user_pref("uc.hidecontext.optionicons", true);
user_pref("uc.hidecontext.pin", true);
...
user_pref("uc.hidecontext.unloadactions", true);
...
// Arkenfox fixes — preserve session data on shutdown
...
// Dark color scheme for content (newtab, about: pages)
user_pref("layout.css.prefers-color-scheme.content-override", 0);
user_pref("browser.in-content.dark-mode", true);

// Reopen previous session on browser start
